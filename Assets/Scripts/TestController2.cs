...
public class TestController2 : MonoBehaviour
{
    ...
    private string[] questions = { "Які з наданих видів досліджень залежать від складності і масштабу поставлених задач:", "Чи всі з перерахованих етапів включає в себе соціологічне дослідження:" };
    private string[][] answers = {
        new string[] { "Розвідувальне (пілотажне)", "Описове", "Аналітичне", "Методологічне" },
        new string[] { "Підготовчий", "Етап збору первинної соціологічної інформації", "Підготовка отриманої інформації до опрацювання та її обробка", "Аналіз опрацьованої інформації, оформлення заключних документів, формулювання висновків та практичних рекомендацій" }
    };
