...
public class TestController16 : MonoBehaviour
{
    ...
    private string[] questions = { "Соціологія молоді функціонує на:" };
    private string[][] answers = {
        new string[] { "Загальнометодологічному рівні", "Спеціально-теоретичному рівні", "Раціональному рівні", "Емпіричному рівні" }
    };
