...
public class TestController5 : MonoBehaviour
{
    ...
    private string[] questions = { "Процес праці включає в себе:", "Соціальні спільноти формуються на основі:" };
    private string[][] answers = {
        new string[] { "Доцільну діяльність людини (сама праця); предмет праці, тобто те, на що спрямована діяльність", "Знаряддя виробництва, якими людина впливає на предмет праці", "Методологічні аспекти функціонування і розвитку соціальних інститутів", "Природні процеси, що відбуваються незалежно від діяльності людини" },
        new string[] { "Культурно-історичної самобутності (народи, нації)", "Пізнання природних явищ і використання їх у культурному розвитку", "Випадкових збігів обставин та моментального соціального контакту", "Родинних зв’язків та схожості стадії життя (сімейні, статево-вікові тощо)" }
    };
