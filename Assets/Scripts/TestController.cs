...
public class TestController : MonoBehaviour
{
    ...
    private string[] questions = { "Об’єктами соціологічного дослідження є:", "До рівнів соціологічного знання відноситься:" };
    private string[][] answers = {
        new string[] { "Соціальні зв’язки", "Економічні зв'язки", "Корпоративна взаємодія", "Соціальна взаємодія", "Соціальні відносини і спосіб їх організації", "Політичні зв'язки" },
        new string[] { "Теоретична соціологія", "Практична соціологія", "Спеціальні соціологічні теорії", "Дедуктивні дослідження", "Індуктивні дослідження", "Емпіричні дослідження" }
    };
