...
public class TestController9 : MonoBehaviour
{
    ...
    private string[] questions = { "Освіта охоплює:", "Освіта є об'єктом дослідження наук:", "Досліджували соціальні функції освіти, педагогічні процеси, а також їх зв'язок із економічними та політичними процесами:" };
    private string[][] answers = {
        new string[] { "Діяльність з навчання та виховання", "Світоглядні і свідоми принципи та зв’язки", "Регулювання відповідними нормами", "Організовану, структуралізовану, рольову діяльність, що опирається на відповідні установи" },
        new string[] { "Політології", "Філософії", "Педагогіки", "Психології" },
        new string[] { "Е. Дюркгейм", "А. Турен", "М. Вебер", "З. Фрейд" }
    };
